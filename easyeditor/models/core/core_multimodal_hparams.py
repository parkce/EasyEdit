...
@dataclass
class CoREMultimodalHparams(HyperParams):
    ...
    def from_hparams(cls, hparams_name_or_path: str):
        ...
        assert (config and config['alg'] == 'CoRE_MULTI') or print(f'CoREMultimodalHparams can not load from {hparams_name_or_path}, '
